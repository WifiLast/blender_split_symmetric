...
class MESH_OT_info_volume(Operator):
    bl_idname = "mesh.cut_sym_info_volume"
...
class MESH_OT_info_area(Operator):
    bl_idname = "mesh.cut_sym_info_area"
...
class MESH_OT_check_solid(Operator):
    bl_idname = "mesh.cut_sym_check_solid"
    bl_label = "Solid"
...
class MESH_OT_check_intersections(Operator):
    bl_idname = "mesh.cut_sym_check_intersect"
...
class MESH_OT_check_shells(Operator):
    bl_idname = "mesh.cut_sym_check_shells"
    bl_label = "Shells"
...
class MESH_OT_check_degenerate(Operator):
    bl_idname = "mesh.cut_sym_check_degenerate"
    bl_label = "Degenerate"
    ...
    def main_check(obj: Object, data: list):
        ...
        threshold = bpy.context.scene.cut_sym.threshold_zero
...
class MESH_OT_check_nonplanar(Operator):
    bl_idname = "mesh.cut_sym_check_nonplanar"
    bl_label = "Non-Planar"
    ...
    def main_check(obj: Object, data: list):
        ...
        angle_nonplanar = bpy.context.scene.cut_sym.angle_nonplanar
...
class MESH_OT_check_thick(Operator):
    bl_idname = "mesh.cut_sym_check_thick"
    bl_label = "Thickness"
    ...
    def main_check(obj: Object, data: list):
        ...
        thickness_min = bpy.context.scene.cut_sym.thickness_min
...
class MESH_OT_check_sharp(Operator):
    bl_idname = "mesh.cut_sym_check_sharp"
    bl_label = "Sharp"
    ...
    def main_check(obj: Object, data: list):
        ...
        angle_sharp = bpy.context.scene.cut_sym.angle_sharp
...
class MESH_OT_check_overhang(Operator):
    bl_idname = "mesh.cut_sym_check_overhang"
    bl_label = "Overhang"
    ...
    def main_check(obj: Object, data: list):
        ...
        angle_overhang = (math.pi / 2.0) - bpy.context.scene.cut_sym.angle_overhang
...
class MESH_OT_check_all(Operator):
    bl_idname = "mesh.cut_sym_check_all"
    bl_label = "Check All"
...
class MESH_OT_report_select(Operator):
    bl_idname = "mesh.cut_sym_select_report"
    bl_label = "Select"
...
class WM_OT_report_clear(Operator):
    bl_idname = "wm.cut_sym_report_clear"
